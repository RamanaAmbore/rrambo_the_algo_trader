...
class PositionsHistorical(Base):
    ...
    buy_price = Column(DECIMAL(10, 2), nullable=False, default=0, server_default="0.00")
    sell_price = Column(DECIMAL(10, 2), nullable=False, default=0, server_default="0.00")
    buy_value = Column(DECIMAL(15, 2), nullable=False, default=0, server_default="0.00")
    sell_value = Column(DECIMAL(15, 2), nullable=False, default=0, server_default="0.00")
    pnl = Column(DECIMAL(12, 2), nullable=False, default=0, server_default="0.00")
    realised = Column(DECIMAL(12, 2), nullable=False, default=0, server_default="0.00")
    unrealised = Column(DECIMAL(12, 2), nullable=False, default=0, server_default="0.00")
    last_price = Column(DECIMAL(10, 2), nullable=False, default=0, server_default="0.00")
    close_price = Column(DECIMAL(10, 2), nullable=False, default=0, server_default="0.00")
    product = Column(String(10), nullable=False)
    overnight = Column(Boolean, nullable=False, default=False, server_default="false")
    multiplier = Column(DECIMAL(5, 2), nullable=False, default=1, server_default="1.00")
